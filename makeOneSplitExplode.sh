...
ogr2ogr ${outputFolder}/${namePrefix}${splitId}diss/ ${outputFolder}/${namePrefix}${splitId}/ -dialect sqlite -sql "SELECT ST_Union(geometry), RABA_ID, 'RABA-KGZ' as source, '2015-10-31' as SOURCEDATE/*, natural, landuse, crop, trees, wetland*/  FROM '${namePrefix}${splitId}' GROUP BY RABA_ID" -nln ${namePrefix}${splitId}diss -explodecollections
echo "  done."
